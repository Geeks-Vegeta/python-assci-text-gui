...
##        scol2=Scrollbar(secondframe,orient="horizontal")
##        scol2.place(relx=0, rely=1, relwidth=1, anchor='sw')
        
        texttopaste=Text(secondframe, height=16.5, width=70,  yscrollcommand=scol1.set, relief="sunken", bd=3,bg="black",fg="white")      
        texttopaste.place(x=1,y=1)
##        scol2.config(command=texttopaste.xview)
